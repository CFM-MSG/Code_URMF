...
def get_data_loaders(args):
    tokenizer = (
        ...
        BertTokenizer.from_pretrained('./prebert/', do_lower_case=True).tokenize 
        if args.model in ["bert", "mmbt", "concatbert","latefusion","tmc"] #tmc
        else str.split
    )
    ...
    val_loader = DataLoader(    #batchsize=128
        dev,
        batch_size=args.batch_sz,
        shuffle=False,
        num_workers=args.n_workers,
